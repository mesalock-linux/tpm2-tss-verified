    ...
    const TPMT_SIG_SCHEME *inScheme)
{
    ...
    iesys_compute_session_value(esysContext->session_tab[0],
                                privacyAdminHandleNode == NULL ? NULL : &privacyAdminHandleNode->rsrc.name,
                                privacyAdminHandleNode == NULL ? NULL : &privacyAdminHandleNode->auth);
    iesys_compute_session_value(esysContext->session_tab[1],
                                signHandleNode == NULL ? NULL : &signHandleNode->rsrc.name,
                                signHandleNode == NULL ? NULL : &signHandleNode->auth);
