    ...
    const TPML_PCR_SELECTION *creationPCR)
{
    ...
    RSRC_NODE_T *primaryHandleNode = NULL;
    ...
    iesys_compute_session_value(esysContext->session_tab[0],
                                primaryHandleNode == NULL ? NULL : &primaryHandleNode->rsrc.name,
                                primaryHandleNode == NULL ? NULL : &primaryHandleNode->auth);
