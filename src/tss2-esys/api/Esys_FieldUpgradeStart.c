    ...
    const TPMT_SIGNATURE *manifestSignature)
{
    ...
    RSRC_NODE_T *authorizationNode = NULL;
    RSRC_NODE_T *keyHandleNode = NULL;
    ...
    iesys_compute_session_value(esysContext->session_tab[0],
                                authorizationNode == NULL ? NULL : &authorizationNode->rsrc.name,
                                authorizationNode == NULL ? NULL : &authorizationNode->auth);
