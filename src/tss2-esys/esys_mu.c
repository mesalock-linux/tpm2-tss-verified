    ...
    size_t *offset)
{
    ...
    return_if_null(offset, "offset=NULL", TSS2_ESYS_RC_BAD_REFERENCE);
    ...
    IESYSC_PARAM_ENCRYPT *dst)
{
    ...
    IESYSC_PARAM_ENCRYPT dst_loc = 0;
    ...
    IESYSC_PARAM_DECRYPT *dst)
{
    ...
    IESYSC_PARAM_DECRYPT dst_loc = 0;
    ...
    IESYSC_TYPE_POLICY_AUTH *dst)
{
    ...
    IESYSC_TYPE_POLICY_AUTH dst_loc = 0;
    ...
    IESYSC_RESOURCE_TYPE *dst)
{
    ...
    IESYSC_RESOURCE_TYPE dst_loc = 0;
    TSS2_RC ret = Tss2_MU_UINT32_Unmarshal(buffer, size,
        offset, &dst_loc);
    return_if_error(ret, "Unmarshaling the base type");
    ...
    IESYS_RESOURCE *dst)
{
    ...
    IESYSC_RESOURCE_TYPE out_rsrcType = 0;
